...
/**
 * This file contains the moodle hooks for the submission plaintext plugin
 *
 ...
 */
function assignsubmission_plaintext_pluginfile($course,
                                                $cm,
                                                context $context,
                                                $filearea,
                                                $args,
    ...
    $fullpath = "/{$context->id}/assignsubmission_plaintext/$filearea/$itemid/$relativepath";
